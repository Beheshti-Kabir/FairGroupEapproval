...
import AprvUserGroupService from "../services/AprvUserGroup.service";
...
export default class AmeGroup extends Component {
    constructor(props) {
        super(props);
        this.onChangeSearchTitle = this.onChangeSearchTitle.bind(this);
        this.clear = this.clear.bind(this);
        this.onClickAddAmendDet = this.onClickAddAmendDet.bind(this);
        this.retrieveAprvUserGroupObjs = this.retrieveAprvUserGroupObjs.bind(this);
    ...
    componentDidMount() {
        ...
        this.retrieveObjs();
        this.clear();
        this.retrieveAprvUserGroupObjs();
    }
    ...
    retrieveAprvUserGroupObjs = () => {

        this.setState({loading: true});
        //AuthService.getAllMinimal()
        AprvUserGroupService.getAllMinimal()
            .then((res) => {
                  //   alert(JSON.stringify(res.data));
                    console.log(res.data);
                  this.setState({
                        loading: false,
                        aprvUserGroups: res.data,
                    });
                })
                .catch((e) => {
                    console.log(e);
...
//                        var nam = this.state.aprvUserGroups.filter(x => x.value === onLine.aprvUserGroup)[0].label;
//
...
//                    mmm['lines'] = nwLins;
    ...
    onChangeSlNo = (e) => {
            const groupSlNo = e.target.value;
    ...
    handleChangeUserSel = (e) => {
        ...
        this.setState(prevState => ({
                currDetObj: {
                    ...prevState.currDetObj,
                    aprvUserGroup: {id: val.value, code: val.label}
                }
            }));
    }
...
//this.setState({currObj: xxx});
    ...
    deleteObj = () => {
        this.setState({loading: true});
        AmeGroupService.delete(this.state.currObj.id)
                .then(res => {
                    this.setState({
                        loading: false,
    ...
    clear = () => {
        this.setState({
            message: '',
            currObj: {description: '', active: false, lines: []}
        });
    }
...
//              alert(JSON.stringify(xxx));
    ...
    onClickAddAmendDet = () => {
        ...
        if (obbb.id === undefined) {
            ...
            var nam = this.state.aprvUserGroups.filter(x => obbb.aprvUserGroup && x.value === obbb.aprvUserGroup.id)[0].label;
            //obbb['name'] = nam;
            obbb['aprvUserGroup'] = {id: obbb.aprvUserGroup.id, name: nam};
                                    ...
                                    <div className="edit-form">
                                        ...
                                        <div className="detail-form">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div className="form-group">
                                                    <Select id="user" options={this.state.aprvUserGroups}
                                                            values={this.state.aprvUserGroups.filter(z => this.state.currDetObj.aprvUserGroup && z.value === this.state.currDetObj.aprvUserGroup.id)}
