...
export default class AmeCondi extends Component {
    constructor(props) {
        super(props);
        ...
        AmeCondiService.get(id)
            .then((res) => {
                ...
                this.setState({
                    loading: false,
                    currObj: res.data,
                    currDetObj: {active: false, slNo: '', condiSql: ''}
                });
...
//this.setState({currObj: xxx});
    ...
    deleteObj = () => {
        this.setState({loading: true});
        AmeCondiService.delete(this.state.currObj.id)
            .then(res => {
                this.setState({
                    loading: false,
...
//        var obbb = this.state.currDetObj;
        ...
        if (obbb.id !== undefined) {
            ...
            xxx['lines'] = ttt;
//              alert(JSON.stringify(xxx));
            this.setState({currObj: xxx, currDetObj: {active: false, slNo: '', condiSql: ''}});
        }
    }
