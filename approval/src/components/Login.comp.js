            ...
            AuthService.login(this.state.username, this.state.password, this.state.isRem)
                    .then((res) => {
                        ...
                        if (res.data.accessToken) {
                            ...
                            CookieService.set("gbl", {dp:res.data.dp,access_token: res.data.accessToken, user: {uid: res.data.uid,
                                    dp:res.data.dp,displayName: res.data.displayName,userType:res.data.userType}}, options);
